	...
	public void onAuthorizationState(AuthorizationState authorizationState) {
		...
		switch (authorizationState.getConstructor()) {
			...
			case TdApi.AuthorizationStateClosed.CONSTRUCTOR:
				...
				break;
			default:
				System.out.println("Unsupported authorization state:\n" + authorizationState);
				break;
		}
	}
	...
	private void onResult(TdApi.Object object) {
		switch (object.getConstructor()) {
			case TdApi.Error.CONSTRUCTOR:
				System.out.println("Receive an error:\n" + object);
				onAuthorizationState(null); // repeat last action
			break;
			case TdApi.Ok.CONSTRUCTOR:
				// result is already received through UpdateAuthorizationState, nothing to do
			break;
			default:
				System.out.println("Receive wrong response from TDLib:\n" + object);
		}
	}
